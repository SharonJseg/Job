...
export const JOBS: IJob[] = [
  ...
  },
  {
    ...
    requirements: {
      content:
        'We are looking to carefully add great developers which care about solving problems & which have been in a relationship with Purescript and',
      items: [
  ...
  },
  {
    ...
    description:
      'Office Lite is seeking a talented and enthusiastic Senior Application Engineer whose primary responsibility is software architecture and development for Office Lite systems. Additional responsibilities include participation in project time',
    requirements: {
      content:
  ...
  },
  {
    ...
    description:
      'Join our dynamic team in developing Pod’s core products and supporting infrastructure. Our software is currently written in Java, VB.Net, React Native, React JS and others. You will help lead new initiatives to build and improve the testing, staging and deployment solutions. You will interact with all development teams, development leadership and our hosting',
    requirements: {
      content:
  ...
  },
  {
    ...
    requirements: {
      content:
        'The candidate must have work experience in all aspects of designing and constructing J2EE',
      items: [
